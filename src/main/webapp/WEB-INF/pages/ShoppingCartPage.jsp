<%@page import="tw.epicer.dao.CartDao"%>
...
<title>Eciper Shopping Cart</title>
...
<body class="u-body u-xl-mode" data-lang="en">
	...
	<%-- 	<%@include file="includes/epicerNavbar.jsp"%> --%>
			...
			<div class="u-cart u-cart-1">
				...
				<div class="u-cart-products-table u-table u-table-responsive">
					<table class="u-table-entity">
						<%
						List<Cart> listCart = (List<Cart>) request.getAttribute("queryById");
								...
								<tr style="height: 50px;">
									...
									<td class="u-border-1 u-border-grey-15 u-table-cell">
										<div
											...
											<div class="u-price-wrapper">
												<div class="u-hide-price u-old-price"></div>
												<div class="u-price"
													style="font-weight: 400; font-size: 1rem;"><%=c.getCartProduct().getPrice()%></div>
											</div>
										</div>
									</td>
									...
									<td class="u-border-1 u-border-grey-15 u-table-cell">
										<div
											...
											<div class="u-price-wrapper">
												<div class="u-hide-price u-old-price"></div>
												<div class="u-price" style="font-weight: 700;"><%=c.getCartProduct().getPrice() * c.getQuantity()%></div>
											</div>
										</div>
									</td>
									<!-- **********修改商品********** -->
										...
										<div
											...
											<div class="u-price-wrapper">
												...
												<div class="u-price" style="font-weight: 400;">
													<span><a class="deleteItem" href="#" title="刪除"> <i
															class="fa-solid fa-trash"
															onclick="deleteCartId('<%=c.getId()%>');"></i>
													</a> </span>
												</div>
											</div>
										</div>
											...
											<tbody
												...
												<tr style="height: 46px;">
													<td
														...
														商品總金額</td>
													<td
														class="u-border-1 u-border-grey-15 u-table-cell u-table-cell-24">$ ${tPrice}
	...
	<%-- 	<%@include file="includes/epicerFooters.jsp"%> --%>
	<script>
		(function(document) {
			'use strict';
