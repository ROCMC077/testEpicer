...
<h1>建立食譜</h1>
    <form action="update.controller"  enctype="multipart/form-data" method="post">
      ...
      $('img').attr('src', objectURL);
        ...
        <div calss="howlong">
            ...
            <select name="time" id="time">
                <option value="null">未設定</option>
                <option value="5分鐘"  <c:if test="${recipe.cookTime=='5分鐘'}">{out.println("selected");}</c:if>>5分鐘</option>
                <option value="10分鐘" <c:if test="${recipe.cookTime=='10分鐘'}">{out.println("selected");}</c:if>>10分鐘</option>
                <option value="15分鐘" <c:if test="${recipe.cookTime=='15分鐘'}">{out.println("selected");}</c:if>>15分鐘</option>
                <option value="20分鐘" <c:if test="${recipe.cookTime=='20分鐘'}">{out.println("selected");}</c:if>>20分鐘</option>
                <option value="25分鐘" <c:if test="${recipe.cookTime=='25分鐘'}">{out.println("selected");}</c:if>>25分鐘</option>
                <option value="30分鐘" <c:if test="${recipe.cookTime=='30分鐘'}">{out.println("selected");}</c:if>>30分鐘</option>
                <option value="35分鐘" <c:if test="${recipe.cookTime=='35分鐘'}">{out.println("selected");}</c:if>>35分鐘</option>
                <option value="40分鐘" <c:if test="${recipe.cookTime=='40分鐘'}">{out.println("selected");}</c:if>>40分鐘</option>
                <option value="45分鐘" <c:if test="${recipe.cookTime=='45分鐘'}">{out.println("selected");}</c:if>>45分鐘</option>
                <option value="50分鐘" <c:if test="${recipe.cookTime=='50分鐘'}">{out.println("selected");}</c:if>>50分鐘</option>
                <option value="55分鐘" <c:if test="${recipe.cookTime=='55分鐘'}">{out.println("selected");}</c:if>>55分鐘</option>
                <option value="60分鐘" <c:if test="${recipe.cookTime=='60分鐘'}">{out.println("selected");}</c:if>>60分鐘</option>
            </select>
