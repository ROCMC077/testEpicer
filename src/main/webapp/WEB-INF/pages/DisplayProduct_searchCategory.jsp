...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="tw.epicer.model.*" %>
<!DOCTYPE html>
<% 
...
<!--     </ul> -->
    ...
    <colgroup>
        ...
        <%
                       ...
                       List<ProductBean> product =(List<ProductBean>)request.getAttribute("searchCategory");
        ...
        <tbody>
		 ...
		 <form ALIGN=center action="./ProductManager_updateConfirm.jsp" method="post">
...
<!--             <button type="submit"> update</button> -->
        ...
        <form ALIGN=center action="./ProductManager_deleteConfirm.jsp" method="post">
            <input type="hidden" name="id" value="<%=pb.getId()%>" >
            <input type="hidden" name="name" value="<%=pb.getName()%>" >
            <input type="hidden" name="description" value="<%=pb.getDescription()%>" >
            <input type="hidden" name="category" value="<%=pb.getCategory()%>" >
